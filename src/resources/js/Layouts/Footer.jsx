...
const today = new Date();
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Smaple1</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Smaple2</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Smaple3</a>
        </p>
        <p>
          <a href="#!" className="text-gray-600">Smaple4</a>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
  ...
  <div className="text-center p-6">
    <span>© {today.getFullYear()} Copyright:</span>
    <a className="text-gray-600 font-semibold" href="/">Nts Japan ltd.</a>
  </div>
</footer>
  )
}
